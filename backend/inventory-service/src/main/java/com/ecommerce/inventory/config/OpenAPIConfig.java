...
public class OpenAPIConfig {
    ...
    public OpenAPI inventoryServiceOpenAPI() {
        ...
        server2.setUrl("http://localhost:8083");
        server2.setDescription("Inventory Service Direct");
        ...
        Info info = new Info()
                ...
                .version("1.0.0")
                .description("Inventory Management Service - Handles stock tracking, warehouse management, and stock reservations")
                .contact(contact)
                .license(license);
