...
public class OpenAPIConfig {
    ...
    public OpenAPI paymentServiceOpenAPI() {
        ...
        server2.setUrl("http://localhost:8085");
        server2.setDescription("Payment Service Direct");
        ...
        Info info = new Info()
                ...
                .version("1.0.0")
                .description("Payment Processing Service - Handles payment transactions, refunds, and multiple payment methods (Credit Card, UPI, COD, PayPal, etc.)")
                .contact(contact)
                .license(license);
